# nvim-treesitter-queries-sproto

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sproto/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sproto/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sproto**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sproto",
...
- [ ] Changes are scoped to `sproto` — do not include files for other languages
